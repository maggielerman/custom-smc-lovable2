        ...
        <div className="grid gap-12 md:grid-cols-2 md:gap-16 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
              Beautiful books for <span className="text-primary">beautiful stories</span>
            </h1>
          ...
          <div className="relative">
            <div className="absolute -bottom-6 -right-6 h-48 w-48 bg-blue-200 rounded-full opacity-50 blur-2xl"></div>
            <div className="absolute -top-6 -left-6 h-48 w-48 bg-purple-200 rounded-full opacity-50 blur-2xl"></div>
